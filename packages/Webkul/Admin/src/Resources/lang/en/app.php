...
return [
    ...
    'sales' => [
        'bids' => [
            'title'                        => 'Bids',
            'view-title'                   => 'Bid #:bid_id',
            'reject-btn-title'             => 'Reject',
            'shipment-btn-title'           => 'Ship',
            'accept-btn-title'            => 'Accept',
            'info'                         => 'Information',
            'invoices'                     => 'Invoices',
            'shipments'                    => 'Shipments',
            'bid-and-account'            => 'Bid and Account',
            'bid-info'                   => 'Bid Information',
            'bid-date'                   => 'Bid Date',
            'bid-status'                 => 'Bid Status',
            'bid-status-canceled'        => 'Canceled',
            'bid-status-rejected'        => 'Rejected',
            'bid-status-closed'          => 'Closed',
            'bid-status-fraud'           => 'Fraud',
            'bid-status-pending'         => 'Pending',
            'bid-status-pending-payment' => 'Pending Payment',
            'bid-status-processing'      => 'Processing',
            'bid-status-success'         => 'Approved',
            'channel'                      => 'Channel',
            ...
            'products-bidded'             => 'Products Bidded',
            'SKU'                          => 'SKU',
            'product-name'                 => 'Product Name',
            'qty'                          => 'Qty',
            'item-status'                  => 'Item Status',
            'item-ordered'                 => 'Bid (:qty_ordered)',
            ...
            'total-due'                    => 'Total Due',
            'cancel-confirm-msg'           => 'Are you sure you want to reject this Bid ?',
            ...
            'transactions'                 => 'Transactions',
            'bid-approve-success'          => 'Bid approved successfully',
            'bid-approve-error'            => 'Bid approve failed',
            'bid-reject-success'          => 'Bid rejected successfully',
            'bid-reject-error'            => 'Bid reject failed',
        ],
        'orders' => [
            'title'                        => 'Orders',
