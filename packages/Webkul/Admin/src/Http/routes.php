    ...
    Route::prefix(config('app.admin_url'))->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('sales')->group(function () {
                // Sales Bids Routes
                Route::get('/bids', 'Webkul\Admin\Http\Controllers\Sales\BidsController@index')->defaults('_config', [
                    'view' => 'admin::sales.bids.index',
                ])->name('admin.sales.bids.index');

                Route::get('/bids/product/{id}', 'Webkul\Admin\Http\Controllers\Sales\BidsController@product_bids')->defaults('_config', [
                    'view' => 'admin::sales.bids.product-bids',
                ])->name('admin.sales.product.bids');
                
                Route::get('/bid/view/{id}', 'Webkul\Admin\Http\Controllers\Sales\BidsController@view')->defaults('_config', [
                    'view' => 'admin::sales.bids.view',
                ])->name('admin.sales.bid.view');
                
                Route::get('/bid/accept/{id}', 'Webkul\Admin\Http\Controllers\Sales\BidsController@accept')->defaults('_config', [
                    'redirect' => 'admin.sales.bids.index',
                ])->name('admin.sales.bids.accept');

                Route::get('/bid/reject/{id}', 'Webkul\Admin\Http\Controllers\Sales\BidsController@reject')->defaults('_config', [
                    'redirect' => 'admin.sales.bids.index',
                ])->name('admin.sales.bids.reject');
