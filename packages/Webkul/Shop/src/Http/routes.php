    ...
    Route::prefix('customer')->group(function () {
        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::get('/selling', function(){
                return view('shop::custom-pages.selling');
            })->name('shop.selling');

            Route::get('/buying', function(){
                return view('shop::custom-pages.buying');
            })->name('shop.buying');

            Route::get('/authentication', function(){
                return view('shop::custom-pages.authentication');
            })->name('shop.authentication');

            Route::get('/privacy', function(){
                return view('shop::custom-pages.privacy');
            })->name('shop.privacy'); 
            
            Route::get('/terms', function(){
                return view('shop::custom-pages.terms');
            })->name('shop.terms');

            Route::get('/purpose', function(){
                return view('shop::custom-pages.purpose');
            })->name('shop.purpose');
            ...
            Route::prefix('account')->group(function () {
                ...
                Route::get('bids/view/{id}', 'Webkul\Shop\Http\Controllers\OrderController@bid_view')->defaults('_config', [
                    'view' => 'shop::customers.account.bids.view'
                ])->name('customer.bids.view');
